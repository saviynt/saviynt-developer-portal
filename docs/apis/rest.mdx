...
Saviynt Identity Cloud APIs are organized around REST protocol, to promote innovation among the developer community. These APIs are designed to have predictable, resource-oriented URLs and use HTTP response codes to indicate API errors.
